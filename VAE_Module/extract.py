...
def worker(dataframe_id):
    ...
    args = {'input_path': '../VAE_Module/data/' + "{0:0=2d}".format(dataframe_id) + '_tracks.csv'}
    ...
    np.save('../VAE_Module/vehicles/vehicle_'+ "{0:0=2d}".format(dataframe_id), np.array(test_data))
    os._exit(os.EX_OK)
